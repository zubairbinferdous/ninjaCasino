...
const OnewinRev = () => {
    return (
        <div>
              <div>
              Get a 10000 BDT bonus when you register with the 1xbet code NEWBONUS. T&Cs apply. Over 18s only.
...
<span>🏠</span> <a href="#">Reviews</a> <span>›</span> <a href="https://1xlite-088578.top/en?tag=d_470241m_97c_NEWBONUS">1xBet</a>
</div>
...
<h3 className="stake-bonus-text">Bet 10,000 Get 10,000 BDT</h3>
...
<button className="stake-claim-btn"><a href="https://1xlite-088578.top/en?tag=d_470241m_97c_NEWBONUS" target="_blank" rel="noreferrer">Claim</a></button>
</div>
</div>
</div>
