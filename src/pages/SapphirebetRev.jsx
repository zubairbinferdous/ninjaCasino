...
import Razed from '../assets/ORG_sapphire-bet3244_29206.svg';
import Footer from './Footer';
import Header from './Header';
import TopFive from './TopFive';
const SapphirebetRev = () => {
    return (
        <div>
  ...
  <div className="stake-breadcrumb">
    <span>🏠</span> <a href="#">Reviews</a> <span>›</span> <a href="#">Sapphirebet </a>
  </div>
  ...
  <div className="stake-review-content">
    ...
    <div className="stake-review-left">
      ...
      <h2 className="stake-title">Sapphirebet Review</h2>
    ...
    {/* Right Side */}
      ...
      <h3 className="stake-bonus-text">Get $90 Sign-up bonus</h3>
      ...
      <button className="stake-claim-btn"><a href="https://sapphirebet.com/en/casino?tag=d_1320883m_22557c_" target="_blank" rel="noreferrer">Claim</a></button>
    </div>
  </div>
</div>
  ...
  <div className="row">
    <div className="col-md-8">
      <h2 className="fw-bold" id="Stake">How To Claim Sapphirebet Promo Code</h2>
      <p>
      ...
      <p>As a crypto casino site, Sapphirebet Casino accepts a decent range of cryptocurrencies as payment options.</p>
      <p>
      ...
      <h3 className="fw-bold" id="FreeSpins">VIP Programmes At Sapphirebet</h3>
      <p>
      ...
      <h3 className="fw-bold" id="Sportsbook">Sapphirebet Sportsbook</h3>
      <p>
        It seemed inevitable that a sportsbook specifically designed for eSports betting would arrive in our market given the steadily growing popularity of cryptocurrencies. Fortunately for us, Sapphirebet is a sportsbook that accepts Bitcoin and is prepared to launch eSports betting in the cryptocurrency community. <br /><br />
        It's not every day that we come across a cryptocurrency sportsbook that offers as many sports and eSports betting choices and numerous payment ways that enable anybody and everyone to play, but Sapphirebet has steadily grown to become one of the top eSports sites evaluated.
      </p>

      <h3 className="fw-bold" id="Markets">Sapphirebet Sports Markets</h3>
      <p>
        Sapphirebet, which has grown in recent years to become one of the top sports betting sites around the world, offers an incredibly huge number of markets to bet on within each of the most popular sports like football. <br /><br />
      ...
      <h5 className="fw-bold" id="CustomerService">Customer Service at Sapphirebet</h5>
      <p>
        Customer satisfaction is crucial to a genuine bookmaker since customers are the foundation of any online betting service. By offering a trustworthy customer care department, Sapphirebet Casino exhibits a clear understanding of this reality and a sincere commitment to communication. <br /><br />
        Every player at Sapphirebet deserves to be treated like a VIP, thus you can count on getting assistance every single day from Sapphirebet customer service.
      </p>

      <h3 className="fw-bold" id="PromoCodesFAQs">Promo Codes FAQs</h3>
      <div className="border-bottom pb-3 mb-3">
        <h5 className="fw-bold">Is Sapphirebet Legal?</h5>
        <p>Sapphirebet is an authorised Curaçao eGaming License holder and a legitimate online casino and sportsbook.</p>
      </div>
      <div className="border-bottom pb-3 mb-3">
        <h5 className="fw-bold">Which Cryptocurrencies Does Sapphirebet Accept?</h5>
        <p>Sapphirebet accepts Bitcoin, Bitcoin Cash, Ethereum, Litecoin, Dogecoin, Tron, and Ripple.</p>
      </div>
      <div>
        <h5 className="fw-bold">What Is The Minimum Deposit At Sapphirebet?</h5>
        <p>
          For cryptocurrencies, there is a Sapphirebet minimum deposit requirement. For instance, you must deposit $/£5 in Bitcoin (0.0001198BTC). The smallest withdrawal amount is likewise $/£5.
        </p>
      </div>
    ...
    <div className="col-md-4">
      <div className="p-3 border rounded bg-light mt30 bg-menu sticky-top">
        <ul className="list-unstyled">
          <li><a href="#Stake" className="text-decoration-none">How To Claim Sapphirebet Promo Code</a></li>
          ...
          <li><a href="#FreeSpins" className="text-decoration-none">VIP Programmes At Sapphirebet</a></li>
          <li><a href="#Sportsbook" className="text-decoration-none">Sapphirebet Sportsbook</a></li>
          <li><a href="#Markets" className="text-decoration-none">Sapphirebet Sports Markets</a></li>
