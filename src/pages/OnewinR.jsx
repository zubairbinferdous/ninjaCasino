...
import Stake from "../assets/due.svg"; // ✅ Ensure correct import
...
<div className="container">
  <div className="row">
    <h2 className="promoo-title mt-5 prom-title">1win Promo Code</h2>
