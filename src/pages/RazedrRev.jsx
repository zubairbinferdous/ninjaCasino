...
const RazedrRev = () => {
  ...
  <div className="stake-review-content">
    ...
    <div className="stake-review-left">
      ...
      <h2 className="stake-title">Razed Review</h2>
  ...
  <div className="row">
    <div className="col-md-8">
      <h2 className="fw-bold" id="Stake">How To Claim Razed Promo Code</h2>
      <p>
      ...
      <p>As a crypto casino site, Razed Casino accepts a decent range of cryptocurrencies as payment options.</p>
      <p>
      ...
      <h3 className="fw-bold" id="FreeSpins">VIP Programmes At Razed</h3>
      <p>
      ...
      <h3 className="fw-bold" id="Sportsbook">Razed Sportsbook</h3>
      <p>
        It seemed inevitable that a sportsbook specifically designed for eSports betting would arrive in our market given the steadily growing popularity of cryptocurrencies. Fortunately for us, Razed is a sportsbook that accepts Bitcoin and is prepared to launch eSports betting in the cryptocurrency community. <br /><br />
        It's not every day that we come across a cryptocurrency sportsbook that offers as many sports and eSports betting choices and numerous payment ways that enable anybody and everyone to play, but Razed has steadily grown to become one of the top eSports sites evaluated.
      </p>

      <h3 className="fw-bold" id="Markets">Razed Sports Markets</h3>
      <p>
        Razed, which has grown in recent years to become one of the top sports betting sites around the world, offers an incredibly huge number of markets to bet on within each of the most popular sports like football. <br /><br />
      ...
      <h5 className="fw-bold" id="CustomerService">Customer Service at Razed</h5>
      <p>
        Customer satisfaction is crucial to a genuine bookmaker since customers are the foundation of any online betting service. By offering a trustworthy customer care department, Razed Casino exhibits a clear understanding of this reality and a sincere commitment to communication. <br /><br />
        Every player at Razed deserves to be treated like a VIP, thus you can count on getting assistance every single day from Razed customer service.
      </p>

      <h3 className="fw-bold" id="PromoCodesFAQs">Promo Codes FAQs</h3>
      <div className="border-bottom pb-3 mb-3">
        <h5 className="fw-bold">Is Razed Legal?</h5>
        <p>Razed is an authorised Curaçao eGaming License holder and a legitimate online casino and sportsbook.</p>
      </div>
      <div className="border-bottom pb-3 mb-3">
        <h5 className="fw-bold">Which Cryptocurrencies Does Razed Accept?</h5>
        <p>Razed accepts Bitcoin, Bitcoin Cash, Ethereum, Litecoin, Dogecoin, Tron, and Ripple.</p>
      </div>
      <div>
        <h5 className="fw-bold">What Is The Minimum Deposit At Razed?</h5>
        <p>
          For cryptocurrencies, there is a Razed minimum deposit requirement. For instance, you must deposit $/£5 in Bitcoin (0.0001198BTC). The smallest withdrawal amount is likewise $/£5.
        </p>
      </div>
    ...
    <div className="col-md-4">
      <div className="p-3 border rounded bg-light mt30 bg-menu sticky-top">
        <ul className="list-unstyled">
          <li><a href="#Stake" className="text-decoration-none">How To Claim Razed Promo Code</a></li>
          ...
          <li><a href="#FreeSpins" className="text-decoration-none">VIP Programmes At Razed</a></li>
          <li><a href="#Sportsbook" className="text-decoration-none">Razed Sportsbook</a></li>
          <li><a href="#Markets" className="text-decoration-none">Razed Sports Markets</a></li>
