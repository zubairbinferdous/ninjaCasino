        ...
        <footer className="footer container-fluid">
            <div className="container">
                <div className="row text-center">
                    ...
                    <div className="col-md-2"><strong><a href="/betting">Betting Sites</a></strong><br /><a href="/Basketball">Basketball</a><br /><a href="/Football">Football</a><br /><a href="/Tennis">Tennis</a></div>
                    <div className="col-md-2"><strong><a href="/Poker">Poker</a></strong></div>
                    <div className="col-md-2"><strong><a href="/Casinos">Casinos</a></strong><br /><a href="/Dealer">Live Dealer</a><br /><a href="/Blackjack">Blackjack</a><br /><a href="/Baccarat">Baccarat</a></div>
